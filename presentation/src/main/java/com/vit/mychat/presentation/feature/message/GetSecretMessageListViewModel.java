...
import com.vit.mychat.domain.usecase.message.GetSecretMessageListUseCase;
...
public class GetSecretMessageListViewModel extends ViewModel {

    @Inject
    GetSecretMessageListUseCase getMessageListUseCase;
    ...
    @Inject
    public GetSecretMessageListViewModel() {
    ...
    public MutableLiveData<Resource> getMessageList(String userId) {
        ...
        }, GetSecretMessageListUseCase.Params.forGetMessageList(userId));

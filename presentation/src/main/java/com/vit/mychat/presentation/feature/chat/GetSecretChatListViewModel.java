...
import com.vit.mychat.domain.usecase.chat.GetSecretChatListUseCase;
...
public class GetSecretChatListViewModel extends ViewModel {

    @Inject
    GetSecretChatListUseCase getChatListUseCase;
    ...
    @Inject
    public GetSecretChatListViewModel() {

...
import com.vit.mychat.domain.usecase.message.SendSecretMessageUseCase;
...
public class SendSecretMessageViewModel extends ViewModel {

    @Inject
    SendSecretMessageUseCase sendMessageUseCase;

    private CompositeDisposable compositeDisposable;
    private SingleLiveEvent<Resource> messageLiveData = new SingleLiveEvent<>();

    @Inject
    public SendSecretMessageViewModel() {
    ...
    public MutableLiveData<Resource> sendMessage(String userId, String message, @MessageTypeConfig String type) {
        ...
        }, SendSecretMessageUseCase.Params.forSendMessage(userId, message, type));

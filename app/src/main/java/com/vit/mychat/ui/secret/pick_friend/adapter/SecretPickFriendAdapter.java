package com.vit.mychat.ui.secret.pick_friend.adapter;
...
@PerActivity
public class SecretPickFriendAdapter extends RecyclerView.Adapter<SecretPickFriendAdapter.SearchViewHolder> {

    private List<UserViewData> mListUserSearch = new ArrayList<>();


    @Inject
    OnClickSecretItemListener listener;

    @Inject
    SecretPickFriendAdapter() {
    }
